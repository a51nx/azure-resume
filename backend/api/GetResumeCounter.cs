...
namespace Company.Function
{
    public static class GetResumeCounter
    {
        ...
        public static HttpResponseMessage Run(
            ...
            // allows us to retrieve item with Id = 1 from our db>container which is the visit count. Uses locally stored azure connection string
            ...
            //After retrieving count, go back to db and increment visits by 1. This requires another binding
